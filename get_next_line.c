...
/*   Updated: 2021/10/07 16:20:48 by jcaetano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	stack_backup = ft_read_fd(fd, stack_backup, heap_buffer);
	if (!stack_backup)
		return (NULL);
	line = ft_format_line(stack_backup);
	stack_backup = ft_format_backup(stack_backup);
	return (line);
}
